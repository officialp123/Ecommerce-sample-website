...
function updateCartUI() {
  ...
  for (const [key, value] of items.entries()) {
    ...
    cartItem.innerHTML = `
      <img src="img/Product D.png"> 
                     <div class="product-content">
                         <h3>Apollo running short</h3>
                         <p>Find stunning women's cocktail dresses and party dresses. stand out in lace and metallic cocktail dresses and party dresses from all your favorite brand
